...
public class Aircraft extends CharMessObject
{
	...
	public Missile missileOpenFire(boolean cameraTrace, Aircraft target, CharFrapsCamera c)
	{
		if(missileMagazineLeft > 0 && isAlive)
		{
			...
			if(cameraTrace)
			{
				m = new Missile
				(
					(short)1280, speed, 256, resistanceRate_normal, 
					cannonLocation, roll_angle, 10, 512, 3.0, this, target, mainCamera, false
				);
			}
			else
			{
				...
				(
					(short)1280, speed, 256, resistanceRate_normal, 
					cannonLocation, roll_angle, 10, 512, 3.0, this, target, c, true
				);
			}
	...
	public Missile missileOpenFire(boolean cameraTrace, Aircraft target)
	{
		if(missileMagazineLeft > 0 && isAlive)
		{
			...
			else
			{
				...
				(
					(short)1280, speed, 256, resistanceRate_normal, 
					cannonLocation, roll_angle, 10, 512, 3.0, this, target, null, true
				);
			}
			...
			if(cannonFireLoadTime <= 0)
			{
				if(cannonMagazineLeft > 0)
				{
					...
					(
						new CannonAmmo
						(
							(short)600, camp, 200 + speed, resistanceRate_normal, 
